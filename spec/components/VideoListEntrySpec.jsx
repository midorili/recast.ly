...
describe('VideoListEntry', function() {
  ...
  beforeEach(function() {
    cuteCatVideo = renderIntoDocument(
      <Wrapper>
        <VideoListEntry video={window.fakeVideoData[0]} clickVideo={() => {}}/>
      </Wrapper>
    );

    superCuteCatVideo = renderIntoDocument(
      <Wrapper>
        <VideoListEntry video={window.fakeVideoData[1]} clickVideo={() => {}} />
      </Wrapper>
    );

    hackReactorVideo = renderIntoDocument(
      <Wrapper>
        <VideoListEntry video={window.fakeVideoData[2]} clickVideo={() => {}} />
      </Wrapper>
    );
  });
